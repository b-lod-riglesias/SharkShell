    ...
    },
    {
        ...
        icon: (
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V20a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 10.5 18.5a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.46-1L4 13.09a2 2 0 1 1 0-4l.08-.02a1.65 1.65 0 0 0 1.46-1 1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9.5A1.65 1.65 0 0 0 11 3.5V3a2 2 0 0 1 4 0v.09A1.65 1.65 0 0 0 13.5 5.5a1.65 1.65 0 0 0-1.82-.33l-.06.06a2 2 0 1 1-2.83 2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82V6.5A1.65 1.65 0 0 0 8.25 4h-.09" />
            </svg>
        ),
    },
];
